...
<body class="bg-white text-gray-900" data-aos="fade-in" data-aos-duration="800">
  ...
  <header class="bg-black text-white py-8 h-64" data-aos="fade-down" data-aos-duration="800">
    <div class="absolute inset-0 flex flex-col justify-center items-center text-center px-4">
      <h1 class="text-3xl font-bold mb-2" data-aos="zoom-in" data-aos-delay="200">Dashboard Hadirin</h1>
  ...
  <nav class="bg-gray-800 py-3" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
    <div class="container mx-auto px-4">
      <ul class="flex flex-wrap justify-center gap-4">
        @if(isset($category) && $category === 'prints')
          @php
            $printItems = [
              ['route' => 'prints.daily.form', 'label' => 'Daily'],
              ['route' => 'prints.monthly.form', 'label' => 'Monthly'],
              ['route' => 'prints.annual.form', 'label' => 'Yearly'],
            ];
          @endphp
